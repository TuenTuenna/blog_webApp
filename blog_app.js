...
/*
  Post Route
*/
// 참조: http://expressjs.com/en/guide/routing.html
app.get("/posts/:postId", function (req, res) {
// 참조: https://lodash.com/docs/4.17.11#lowerCase
  const requestedTitle = _.lowerCase(req.params.postId);
  // res.send(req.params)
  // console.log(req.params.postId);
  // url 이 포스트 배열에 있으면 알려준다.
  posts.forEach(function(post){
    const storedTitle = _.lowerCase(post.title);
      // console.log("req.params.postId : " + requestedTitle);
      // console.log("post.title : " + storedTitle);
      if(storedTitle === requestedTitle){
          // console.log("Match found!");
          // post.ejs 파일을 열고 값을 보내준다.
